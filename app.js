var SmartMultiFiled = (function(){
    ...
    function formHtml() {
        ...
        html += '<td>';
        html += '<button scope="row" id="delete_'+rowcount+'" class="btn btn-danger delete_row">-</button>';
        html += '</td>';
        html += '<td>';
        ...
        html += '</td>';
        html += '<td>';
        html += '<input type="text" data-type="countryno" name="countryno[]" id="countryno_'+rowcount+'" class="form-control autocomplete_txt" autocomplete="off" readonly>';
        html += '</td>';
        html += '<td>';
        html += '<input type="text" data-type="phone_code" name="phone_code[]" id="phone_code_'+rowcount+'" class="form-control autocomplete_txt" autocomplete="off" readonly>';
        html += '</td>';

        html += '<td>';
        html += '<input type="number" data-type="country_code" name="country_code[]" id="country_code_'+rowcount+'" class="form-control autocomplete_txt" autocomplete="off">';
        html += '</td>';
        html += '</tr>';
        rowcount++;
        return html;
